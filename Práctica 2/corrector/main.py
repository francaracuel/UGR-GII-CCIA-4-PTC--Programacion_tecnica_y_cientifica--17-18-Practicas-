...
Práctica 2 - Gestión de test - Corrector de tests

main.py - Fichero principal desde donde se corrigen los tests
...
if __name__ == "__main__":
    ...
    # Nombre del fichero que guarda los tests
    #filename_weather = "tests.xml"
